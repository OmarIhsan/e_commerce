  ...
  return (
    <div className="space-y-12">
      ...
      <nav className="flex items-center gap-2 text-xs text-slate-500 dark:text-titanium-400">
        ...
        <ChevronRight className="w-3.5 h-3.5 text-slate-400 dark:text-titanium-600" />
        <Link
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden bg-slate-100 dark:bg-titanium-950 aspect-4/3 relative group shadow-xs">
            <img
          ...
          <div className="hidden lg:block space-y-6 pt-6 border-t border-slate-200 dark:border-white/10">
            <div className="space-y-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-titanium-200">
                {dict.product.overview}
              </h3>
              <p className="text-sm text-slate-600 dark:text-titanium-300 leading-relaxed">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  {Object.entries(product.specs).map(([key, val]) => (
                    <div
                      key={key}
                      className="p-3 rounded-lg bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/5 shadow-xs"
                    >
                      <div className="text-slate-400 dark:text-titanium-400 text-[10px] uppercase">{key}</div>
                      <div className="text-slate-800 dark:text-titanium-200 font-semibold mt-0.5">{val}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="space-y-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-xs text-slate-700 dark:text-titanium-300">
                  <Star className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 fill-amber-500 dark:fill-amber-400" />
                  <span className="font-semibold">{product.rating.toFixed(1)}</span>
                  <span className="text-slate-400 dark:text-titanium-500">({product.reviewsCount})</span>
                </div>
            ...
            <div className="text-xs text-slate-500 dark:text-titanium-400">
              SKU: <span className="text-slate-800 dark:text-titanium-300 font-medium">{product.sku}</span>
            </div>
          </div>

          <div className="p-4 rounded-xl bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/10 flex items-baseline gap-3 shadow-xs">
            <span className="text-3xl font-extrabold text-slate-900 dark:text-white">
              ${product.price.toFixed(2)}
            </span>
            {product.compareAt && (
              <span className="text-sm text-slate-400 dark:text-titanium-500 line-through">
                ${product.compareAt.toFixed(2)}
              </span>
            )}
            {product.discount && (
              <span className="px-2 py-0.5 rounded-md bg-rose-500/10 dark:bg-rose-500/20 border border-rose-500/30 text-xs font-bold text-rose-600 dark:text-rose-400 uppercase">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="p-3 rounded-lg bg-white dark:bg-titanium-900/60 border border-slate-200 dark:border-white/5 flex items-center gap-2.5 shadow-xs">
              <ShieldCheck className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
              <div className="text-[11px] leading-tight text-slate-600 dark:text-titanium-300">
                <span className="font-semibold text-slate-900 dark:text-white block">{dict.product.freeDelivery}</span>
            ...
            <div className="p-3 rounded-lg bg-white dark:bg-titanium-900/60 border border-slate-200 dark:border-white/5 flex items-center gap-2.5 shadow-xs">
              ...
              <div className="text-[11px] leading-tight text-slate-600 dark:text-titanium-300">
                <span className="font-semibold text-slate-900 dark:text-white block">{dict.product.verifiedItem}</span>
                {dict.benefits.qualityDesc}
              </div>
            </div>
          </div>

          <div className="lg:hidden space-y-4 pt-6 border-t border-slate-200 dark:border-white/10">
            <div className="space-y-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-titanium-200">
                {dict.product.overview}
              </h3>
      ...
      <section className="space-y-6 pt-10 border-t border-slate-200 dark:border-white/10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-titanium-400 mt-0.5">
              {dict.benefits.qualityDesc}
            </p>
          </div>
          <ProductReviewModal productName={product.name} sku={product.sku} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 rounded-xl bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/10 space-y-3 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="font-bold text-xs text-slate-900 dark:text-white">Alex M.</span>
            ...
            <p className="text-xs text-slate-600 dark:text-titanium-300 leading-relaxed">
            ...
            <span className="text-[10px] text-slate-400 dark:text-titanium-500 block">
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/10 space-y-3 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="font-bold text-xs text-slate-900 dark:text-white">Sarah T.</span>
              <div className="flex text-amber-500 dark:text-amber-400 text-xs">★★★★★</div>
            </div>
            <h4 className="font-semibold text-xs text-blue-600 dark:text-blue-400">
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/10 space-y-3 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="font-bold text-xs text-slate-900 dark:text-white">David L.</span>
              <div className="flex text-amber-500 dark:text-amber-400 text-xs">★★★★☆</div>
            </div>
            <h4 className="font-semibold text-xs text-blue-600 dark:text-blue-400">
