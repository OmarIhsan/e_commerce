...
export default async function CategoryPage({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header Banner */}
      <div className="p-8 rounded-2xl bg-white dark:bg-titanium-900 border border-slate-200 dark:border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
        <div>
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-[11px] font-semibold text-blue-600 dark:text-blue-400 mb-2">
        ...
        <Link
          ...
          className="px-4 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center gap-2 self-start sm:self-auto shadow-sm transition-colors cursor-pointer"
        >
